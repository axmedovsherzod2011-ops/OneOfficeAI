...
// Structured AI generation for product posts/research uses the OneOffice CPU model only.
// Cloud providers remain available for explicit cloud-backed features such as image generation.
