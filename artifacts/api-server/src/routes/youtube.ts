...
// ---------------------------------------------------------------------------
// AI provider chain — endi shared textProviders.ts'dan ishlatamiz (avval
// bu yerda alohida nusxasi bor edi; endi bitta joyda, ikkinchi Gemini
// kalitini ham avtomatik oladi).
// ---------------------------------------------------------------------------
